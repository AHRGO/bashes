...
# goes through all the merged stream, being the entry point to shortcuts
...
# merges the current branch into the target branch, being the target a hardcorded one
d4c() {
